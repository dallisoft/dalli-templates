...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Posts",
    subItems: [
      { name: "Post List", path: "/posts", pro: false },
      { name: "New Post", path: "/posts/new", pro: false },
    ],
  },
];
...
const othersItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Loading Demo", path: "/loading-demo", pro: false },
    ],
  },
  {
    icon: <PlugInIcon />,
...
const AppSidebar: React.FC = () => {
  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "others") => (
    <ul className="flex flex-col gap-4">
      {items.map((nav, index) => {
        // Filter out Users menu for non-admin users
