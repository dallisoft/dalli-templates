...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Dalli Template - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Dalli Template - React.js Tailwind CSS Admin Dashboard Template"
      />
