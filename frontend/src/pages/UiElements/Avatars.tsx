...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Dalli Template - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Dalli Template - React.js Tailwind CSS Admin Dashboard Template"
      />
