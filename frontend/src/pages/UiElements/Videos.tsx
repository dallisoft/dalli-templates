...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Dalli Template - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Dalli Template - React.js Tailwind CSS Admin Dashboard Template"
      />
